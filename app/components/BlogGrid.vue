        ...
        <div class="col-lg-8">
          <div class="bsingle__post mb-50">
            ...
            <div class="bsingle__content">
              ...
              <h2><NuxtLink to="/blog-details">Lorem ipsum dolor sit amet, consectetur cing elit, sed do eiusmod tempor.</NuxtLink></h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.Duis aute irure dolor in reprehenderit in voluptate velit esse.</p>
              <div class="blog__btn">
                <NuxtLink to="/blog-details" class="btn">Read More</NuxtLink>
              </div>
            </div>
          </div>
          <div class="bsingle__post mb-50">
            ...
            <div class="bsingle__content">
              ...
              <h2><NuxtLink to="/blog-details">There are many variations passages of like consectetur lorem ipsum available.</NuxtLink></h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.Duis aute irure dolor in reprehenderit in voluptate velit esse.</p>
              <div class="blog__btn">
                <NuxtLink to="/blog-details" class="btn">Read More</NuxtLink>
              </div>
          ...
          <div class="bsingle__post mb-50">
            ...
            <div class="bsingle__content">
              ...
              <h2><NuxtLink to="/blog-details">I must explain to you how all this mistaken idea of denouncing pleasure.</NuxtLink></h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.Duis aute irure dolor in reprehenderit in voluptate velit esse.</p>
              <div class="blog__btn">
                <NuxtLink to="/blog-details" class="btn">Read More</NuxtLink>
              </div>
...
onMounted(() => {
    // Re-initialize plugins if needed, but since we are navigating, 
    // Nuxt might handle some. However, jquery plugins need manual trigger.
    setTimeout(() => {
